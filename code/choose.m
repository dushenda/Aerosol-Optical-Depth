...
% --- Executes on button press in inputNumber.
...
% --- Executes on button press in loadXls.
function loadXls_Callback(hObject, eventdata, handles)
% hObject    handle to loadXls (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
global choosetype;
choosetype=1;
[FileName,PathName] = uigetfile('input.xls');
