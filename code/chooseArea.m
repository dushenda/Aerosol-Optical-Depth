...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @chooseArea_OpeningFcn, ...
                   'gui_OutputFcn',  @chooseArea_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% UIWAIT makes chooseArea wait for user response (see UIRESUME)
uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = chooseArea_OutputFcn(hObject, eventdata, handles)
...
% --- Executes on button press in ES.
