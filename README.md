...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Δτ.png)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Al5table.png)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/PreProcess.png)
$$
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Finalstep (1).png)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Al1.png)

#### 算法的结果

![](https://github.com/dushenda/OpticalDepth/tree/master/img/第一种算法.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Al2.png)

#### 算法的结果

![](https://github.com/dushenda/OpticalDepth/tree/master/img/第二种算法.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Al3.png)

#### 算法的结果

![](https://github.com/dushenda/OpticalDepth/tree/master/img/第三种算法.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Al4(1).png)

![Al4(2)](https://github.com/dushenda/OpticalDepth/tree/master/img/Al4(2).png)

#### 算法结果

![](https://github.com/dushenda/OpticalDepth/tree/master/img/第四种算法.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/Al5(2).png)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/第五种算法.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/算法5_8月7日角度值.bmp)

​										图 1.7  计算的天顶角

![](https://github.com/dushenda/OpticalDepth/tree/master/img/算法5_8月7日误差散点.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/算法5_8月7日分布图.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/算法1~算法4.bmp)

​											图 1.10  计算汇总 1

![](https://github.com/dushenda/OpticalDepth/tree/master/img/算法0和算法5.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/表格1.png)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/表格2.png)

​	上面的这张表格也就说明了在文章计算的数据中天顶角γ的取值变化，也就是计算的时候自变量所采用的值。过计算得到了一些结果。

### 结果

![](https://github.com/dushenda/OpticalDepth/tree/master/img/几种方法计算的大气质量.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/三种计算方法计算的值.bmp)

​									图 2.3  三种拟合系数计算的大气质量

![](https://github.com/dushenda/OpticalDepth/tree/master/img/几种方法计算的大气质量的误差值.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/高度角大于10°的大气质量误差.bmp)

​							图 2.5  在高度角大于10°时候计算大气质量的误差

​	这里没有找到拟合系数1这条曲线，是因为他的变化与公式计算的是一模一样的，两条线是重合的。

![](https://github.com/dushenda/OpticalDepth/tree/master/img/找拟合系数1这条线.bmp)
...
![](https://github.com/dushenda/OpticalDepth/tree/master/img/8月6号到8号计算的大气质量值.bmp)
